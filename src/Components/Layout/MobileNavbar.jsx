...
const MobileNavbar = () => {
  ...
  return (
    <>
    <header className='md:hidden block bg-[#101010]'>
    <div className=" container mx-auto flex items-center justify-between py-3 sticky top-0 z-40 bg-[#101010]">
  ...
  <div className="z-40 p-4 h-screen overflow-y-auto w-96 text-white">
    ...
    <div className="py-2 gap-10 overflow-y-auto flex-col flex justify-center items-center h-full">
      ...
      <ul onClick={toggleDrawer} className="space-y-6 font-bold text-center text-xl">
        ...
        <li>
        <Link href="/resume" className="mr-5 hover:text-gray-300 hover:scale-110 text-center">Resume</Link>
        </li>
    ...
    <Link to="/resume" className="inline-flex items-center bg-gray-800 border-2 py-2 px-6 border-gray-600 focus:outline-none hover:bg-gray-200 rounded-xl text-base mt-4 md:mt-0">Resume
    </Link>
    <Link to="/contact" className="inline-flex items-center bg-blue-700 border-2 py-2 px-6 border-gray-600 focus:outline-none hover:bg-gray-200 rounded-xl text-base mt-4 md:mt-0">Contact Me
